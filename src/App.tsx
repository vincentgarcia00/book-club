...
import {PageHeader, Row, Col, Divider, Button, Layout, Tag, Spin} from 'antd';
  ...
  return (
      <div className="App">
...

        {
          ...
          </> : <div style={{textAlign: 'center', margin: 15}}><Spin size="large" /></div>
        }

        <Layout.Footer style={{ textAlign: 'center' }}>Made by Maria Knabe 2022<br />Using Ant Design and Sheet Best</Layout.Footer>
      </div>
  );
};
